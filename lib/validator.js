...
/**
 * Allow developers to add a custom format in order to use it in schema declarations
 * Example :
 * <ul>
 * <li>New format configuration at initialization : <pre><code>Validator.prototype.addFormat("objectid", /^[0-9a-fA-F]{24}$/);</code></pre></li>
 * <li>Then in your schema declaration : <pre><code>
     var schema= {
        "id" : "/Schema2",
        "type" : "object",
        "properties" : {
