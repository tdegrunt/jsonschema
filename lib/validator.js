...
Validator.prototype.addFormat = function addFormat (name, handler) {
  attribute.validators.addFormat(name, handler);
}
...
Validator.prototype.validateSchema = function validateSchema (instance, schema, options, ctx) {
  ...
  */
  ...
  if (schema.properties) {
    if (instance && !Validator.prototype.types['object'](instance)) {
      result.importErrors('is not an object');
