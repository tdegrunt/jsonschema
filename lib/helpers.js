...
ValidatorResult.prototype.addError = function addError(message, propertyPath) {
  var err = new ValidationError(message, this.instance, this.schema, propertyPath || this.propertyPath);
  if (this.throwError) {
    throw err;
  }
...
SchemaContext.prototype.makeChild = function makeChild(schema, propertyName){
  var propertyPath = (propertyName===undefined) ? this.propertyPath : ((this.propertyPath != '') ? this.propertyPath+makeSuffix(propertyName) : propertyName);
...
exports.isFormat = function isFormat (input, format) {
  var handler = FORMAT_REGEXPS[format];
