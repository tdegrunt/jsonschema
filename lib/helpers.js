...
var SchemaContext = exports.SchemaContext = function SchemaContext(schema, options, propertyPath, base, schemas){
  ...
  this.base = uri.resolve(base, schema.id||'');
...
SchemaContext.prototype.makeChild = function makeChild(schema, propertyName){
  ...
  var ctx = new SchemaContext(schema, this.options, propertyPath, this.base, Object.create(this.schemas));
  var id = ctx.base;
  if(schema.id && !ctx.schemas[id]) ctx.schemas[id] = schema;
  return ctx;
}
