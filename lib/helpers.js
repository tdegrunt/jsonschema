...
var ValidationError = exports.ValidationError = function ValidationError (message, instance, schema, propertyPath, validatorType) {
  if (propertyPath) {
...
ValidatorResult.prototype.addError = function addError(detail) {
  ...
  if (typeof detail == 'string') {
    ...
    err = new ValidationError(detail.message, this.instance, this.schema, this.propertyPath, detail.validatorType);
  }
