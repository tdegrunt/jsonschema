...
Attribute.prototype.validate = function () {
  ...
  var validationFunc = validators[this.name];
  if (validationFunc) {
    return validationFunc.call(this);
  } else {
...
validators.type = function validateType() {
  var valid = false;
  switch (this.value) {
  case 'string':
...
validators.minimum = function validateMinimum() {
  var valid = true;
...
// Only applicable for numbers
validators.maximum = function validateMaximum() {
  var valid = true;
...
// Only applicable for numbers
validators.$ref = function validate$ref() {
...
validators.pattern = function validatePattern() {
  var valid = true;
...
// Only applicable for strings, ignored otherwise
validators.format = function validateFormat() {
...
validators.enum = function validateEnum() {
  var valid = false;
