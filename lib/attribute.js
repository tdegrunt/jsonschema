 ...
 * @param properties all the properties of an instance
 * @param property the current property to check
 * @param instance the instance in which property value will be replaced by a type if needed
 * @private
 */
function replaceFormatBySpecificObject (validator, properties, property, instance ) {
