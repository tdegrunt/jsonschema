...
describe('Formats', function() {
  ...
  describe('date-time', function() {
    it('should validate a valid date-time', function() {
      this.validator.validate("2012-07-08T16:41:41.532Z", {
        'type': 'string',
        'format': 'date-time'
    ...
    it('should validate a valid date-time without milliseconds', function() {
      this.validator.validate("2012-07-08T16:41:41Z", {
        'type': 'string',
        'format': 'date-time'
      }).valid.should.be.true;
    });
    ...
    it('should validate a date-time with a timezone offset instead of Z', function() {
      ...
      this.validator.validate("2012-07-08T16:41:41.532+05:30", {
        'type': 'string',
        'format': 'date-time'
      }).valid.should.be.true;
      this.validator.validate("2012-07-08T16:41:41.532+04:00", {
        'type': 'string',
        'format': 'date-time'
      }).valid.should.be.true;
    });

    it('should validate a date-time with timezone adjustment and milliseconds', function() {
      this.validator.validate("2014-07-17T19:08:05.7126000+00:00", {
        'type': 'string',
        'format': 'date-time'
      }).valid.should.be.true;
    });

    it('should validate a date-time with milliseconds', function() {
      this.validator.validate("2014-06-27T21:26:26.91", {
        'type': 'string',
        'format': 'date-time'
      }).valid.should.be.true;
    });
    ...
    it('should validate a date-time with a space instead of a T', function() {
      this.validator.validate("2012-07-08 16:41:41.532Z", {
        'type': 'string',
        'format': 'date-time'
      }).valid.should.be.true;
    });
    ...
    it('should not validate a date-time with the time missing', function() {
      this.validator.validate("2012-07-08", {
        'type': 'string',
        'format': 'date-time'
    ...
    it('should not validate an invalid date-time', function() {
      this.validator.validate("TEST2012-07-08T16:41:41.532Z", {
        'type': 'string',
        'format': 'date-time'
      }).valid.should.be.false;
    });
    ...
    it('should not validate a date-time with a timezone offset AND a Z', function() {
      this.validator.validate("2012-07-08T16:41:41.532+00:00Z", {
        'type': 'string',
        'format': 'date-time'
      }).valid.should.be.false;
      this.validator.validate("2012-07-08T16:41:41.532+Z00:00", {
        'type': 'string',
        'format': 'date-time'
      }).valid.should.be.false;
    });
  ...
  describe('date', function() {
    ...
    it('should not validate an invalid date', function() {
      this.validator.validate("TEST2012-07-08", {
        'type': 'string',
        'format': 'date'
      }).valid.should.be.false;
    });
  ...
  describe('time', function() {
    it('should validate a valid time', function() {
      this.validator.validate("16:41:41", {
        'type': 'string',
        'format': 'time'
      }).valid.should.be.true;
    });
    ...
    it('should not validate an invalid time', function() {
      this.validator.validate("16:41:41.532Z", {
        'type': 'string',
        'format': 'time'
      }).valid.should.be.false;
    });
  ...
  describe('color', function() {
    ...
    it('should validate the color #ff0000', function() {
      this.validator.validate("#ff0000", {
        'type': 'string',
        'format': 'color'
      }).valid.should.be.true;
    });
    ...
    it('should validate the color rgb(255,0,0)', function() {
      this.validator.validate("rgb(255,0,0)", {
        'type': 'string',
        'format': 'color'
      }).valid.should.be.true;
    });
  ...
  describe('style', function() {
    it('should validate a valid style', function() {
      this.validator.validate("color: red;", {
        'type': 'string',
        'format': 'style'
      }).valid.should.be.true;
    });
    ...
    it('should validate a valid complex style', function() {
      this.validator.validate("color: red; position: absolute; background-color: rgb(204, 204, 204); max-width: 150px;", {
        'type': 'string',
        'format': 'style'
      }).valid.should.be.true;
    });
  ...
  describe('phone', function() {
    it('should validate a valid phone-number', function() {
      this.validator.validate("+31 42 123 4567", {
        'type': 'string',
        'format': 'phone'
      }).valid.should.be.true;
    });
  ...
  describe('uri', function() {
    it('should validate http://www.google.com/', function() {
      this.validator.validate("http://www.google.com/", {
        'type': 'string',
        'format': 'uri'
      }).valid.should.be.true;
    });
    ...
    it('should validate http://www.google.com/search', function() {
      this.validator.validate("http://www.google.com/search", {
        'type': 'string',
        'format': 'uri'
      }).valid.should.be.true;
    });
    ...
    it('should not validate relative URIs', function() {
      this.validator.validate("tdegrunt", {
        'type': 'string',
        'format': 'uri'
      }).valid.should.be.false;
    });
    ...
    it('should not validate with whitespace', function() {
      this.validator.validate("The dog jumped", {
        'type': 'string',
        'format': 'uri'
      }).valid.should.be.false;
    });
  ...
  describe('email', function() {
    it('should validate obama@whitehouse.gov', function() {
      this.validator.validate("obama@whitehouse.gov", {
        'type': 'string',
        'format': 'email'
      }).valid.should.be.true;
    });
    ...
    it('should validate barack+obama@whitehouse.gov', function() {
      this.validator.validate("barack+obama@whitehouse.gov", {
        'type': 'string',
        'format': 'email'
      }).valid.should.be.true;
    });
  ...
  describe('ip-address', function() {
    ...
    it('should not validate 192.168.0', function() {
      this.validator.validate("192.168.0", {
        'type': 'string',
        'format': 'ip-address'
      }).valid.should.be.false;
    });
    ...
    it('should not validate 256.168.0', function() {
      this.validator.validate("256.168.0", {
        'type': 'string',
        'format': 'ip-address'
      }).valid.should.be.false;
    });
  ...
  describe('ipv6', function() {
    it('should validate fe80::1%lo0', function() {
      this.validator.validate("fe80::1%lo0", {
        'type': 'string',
        'format': 'ipv6'
      }).valid.should.be.true;
    });
  ...
  describe('host-name', function() {
    ...
    it('should validate www.google.com', function() {
      this.validator.validate("www.google.com", {
        'type': 'string',
        'format': 'host-name'
      }).valid.should.be.true;
    });
    ...
    it('should not validate www.-hi-.com', function() {
      this.validator.validate("www.-hi-.com", {
        'type': 'string',
        'format': 'host-name'
      }).valid.should.be.false;
    });
  ...
  describe('alpha', function() {
    ...
    it('should validate abracadabra', function() {
      this.validator.validate("abracadabra", {
        'type': 'string',
        'format': 'alpha'
      }).valid.should.be.true;
    });
  ...
  describe('alphanumeric', function() {
    ...
    it('should validate abracadabra123', function() {
      this.validator.validate("abracadabra123", {
        'type': 'string',
        'format': 'alphanumeric'
      }).valid.should.be.true;
    });
